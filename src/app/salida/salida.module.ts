...
import { EditNodatComponent } from './components/editNodat-form/editNodat-form.component';
...
@NgModule({
  declarations: [SalidaComponent, SalidaFormComponent, SalidaListaComponent,EnvioFormComponent,EditNodatComponent],
  imports: [
    CommonModule,
    SalidaRoutingModule,
    MatDialogModule,
