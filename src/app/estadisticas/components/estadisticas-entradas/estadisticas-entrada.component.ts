...
@Component({
  selector: 'app-estadisticas-entrada',
  templateUrl: './estadisticas-entrada.component.html',
  styleUrls: ['./estadisticas-entrada.component.scss'],
  encapsulation: ViewEncapsulation.None,

})


export class EstadisticasEntradaComponent implements OnInit {
  typeStructs=[];
  structs=[];
  ...
  constructor(private inpServ: InputService, private loginService:LoginService,private datePipe: DatePipe,) {}
  ...
  getEstadisticasAll(){
    ...
    this.inpServ.getAllInputStatistics().subscribe((data:any)=>{
    ...
    getStructs(struct_id){
      if(struct_id!=0 && struct_id!=null){
        ...
        this.inpServ.getStructInputStatistics(struct_id).subscribe((data:any)=>{
    ...
    getEstadisticasAllFecha(){
      if(this.form.value.desde && this.form.value.hasta && this.form.valid){
        ...
        this.inpServ.getAllInputStatisticsFecha({
          desde: desde,
          hasta: hasta,
        }).subscribe((data:any)=>{
          this.typeStructs= data.types_structs;
    ...
    getStructsFecha(){
      if(this.formSt.valid){
        ...
        this.inpServ.getStructInputStatisticsFecha({
