...
@Component({
  selector: 'app-estadisticas-salida',
  templateUrl: './estadisticas-salida.component.html',
  styleUrls: ['./estadisticas-salida.component.scss'],
  encapsulation: ViewEncapsulation.None,

})


export class EstadisticasSalidaComponent implements OnInit {
  typeStructs=[];
  structs=[];
